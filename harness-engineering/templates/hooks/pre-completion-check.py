...
TASK_HARNESS_CHECKLIST = [
    "7. If this sprint maps to feature_list.json, qa score is >= 80/100 before passes=true?",
    "8. If feature status changed, feature_list.json and progress.txt are both updated?",
]
